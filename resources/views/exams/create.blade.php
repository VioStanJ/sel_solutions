    ...
    <div class="header bg-primary pb-6 pt-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">Créer Examen</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    <li class="breadcrumb-item"><a href="/"><i class="fas fa-home"></i></a></li>
                    {{-- <li class="breadcrumb-item active" aria-current="page">Créer Examen</li> --}}
                </ol>
                </nav>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Ex : Glicerine') }}" value="{{ old('name')}}" required autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('non') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="non" id="input-name" class="form-control form-control-alternative{{ $errors->has('non') ? ' is-invalid' : '' }}" placeholder="{{ __('Ex : Gliserin ( Sik )') }}" value="{{ old('non') }}" required autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('from') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="from" id="input-name" class="form-control form-control-alternative{{ $errors->has('from') ? ' is-invalid' : '' }}" value="{{ old('from') }}" required  step="any">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('to') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="to" id="input-name" class="form-control form-control-alternative{{ $errors->has('to') ? ' is-invalid' : '' }}" value="{{ old('to') }}"  step="any" >
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('val') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="val" id="input-name" class="form-control form-control-alternative{{ $errors->has('val') ? ' is-invalid' : '' }}" value="{{ old('val') }}" placeholder="Ex: g/L" required  step="any">
